...
func (c *Context) RealIP() string {
	if c.gecko != nil && c.gecko.IPExtractor != nil {
		return c.gecko.IPExtractor(c.request)
	}
...
// FUENTE: https://echo.labstack.com/docs/ip-address
...
// See https://gecko.labstack.com/guide/ip-address for more details.
